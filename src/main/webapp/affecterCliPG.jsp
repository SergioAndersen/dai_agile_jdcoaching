<%-- 
    Document   : affecterCliPG
    Created on : 4 avr. 2018, 10:45:46
    Author     : evaba
--%>
            ...
            <div class="container">
                <div class="row mar-bot40">
                    <div class="section-header">
                        <h2 class="section-heading animated" data-animation="bounceInUp">Liste des programmes</h2>
                    </div>
                    <br><br>

                    <div class="cform" id="contact-form">
                        <form name="affectCli" action="affecterCli.jsp" method="get">

                            <%
                                out.println("<div class='row mar-bot40'><div class='col-md-offset-4 col-md-6'>"
                                        + session.getAttribute("emailCli") + "<br><br><br>");
                                ArrayList<Programme> lstProg = bd.recuperationProgramme();
                                for (Programme pg : lstProg) {
                                    out.println("<input type='radio' value='" + pg.getCodePT() + "' name='affecter' required='required'>  " + pg.getLibellePT()
                                            + "<br><br><br>");
                                    out.println("");
                                }
                            %>

                            <input type="submit" value="Affecter" class="btn-get-started scrollto"/>
