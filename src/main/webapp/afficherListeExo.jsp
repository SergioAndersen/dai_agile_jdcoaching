                    ...
                    <div class="col-md-offset-3 col-md-6">
                        <div class="cform" id="contact-form">
                            ...
                            <div class="field your-name form-group">
                                ...
                                <form name="affectCli" action="servletAffExercice" method="get">
                                    <h1>Liste des exercices</h1>

                                    <%
                                        ArrayList<Exercice> lstexo = bd.obtenirListeExo();
                                        for (Exercice exo : lstexo) {

                                            out.println("<br>");
                                            out.println("<H4>" + exo.getLibelleEx() + "</H4>");
                                            out.println("<input type='submit'  id='" + exo.getCodeEx() + "'   name='codeExAff' value='" + exo.getCodeEx() + "' class='btn-get-started scrollto' size='40'> </input>");
