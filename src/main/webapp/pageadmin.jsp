        ...
        <section id="section-services" class="section pad-bot30 bg-white">
            <div class="container">
                ...
                <div class="row mar-bot40">
                    ...
                    <div class="col-lg-5">
                        <a href="listeTtClient.jsp"><h3 class="text-bold">Visualiser la liste des clients</h3></a>
                ...
                <div class="row mar-bot40">
                    ...
                    <div class="col-lg-5">
                        ...
                        <p> Vous pouvez inscrire un client rapidement. </p>
                        <div class="clear"></div>
                    </div>
                    
                    <div class="col-lg-5">
                        <a href="ajoutProf.jsp"><h3 class="text-bold">Ajouter un profil pour des programmes</h3></a>
                        <p> Vous pouvez ajouter un profil pour des programmes. </p>
                        <div class="clear"></div>
                </div>
            </div>
                <br>
                ...
                <div class="row mar-bot40">
                    <div class="col-lg-1"></div>
                    <div class="col-lg-5">
                        <a href="ajoutTypes.jsp"><h3 class="text-bold">Ajouter une catégorie pour des séances</h3></a>
                        <p> Vous pouvez ajouter une catégorie pour des séances. </p>
                        <div class="clear"></div>
                    </div>
                </div>
