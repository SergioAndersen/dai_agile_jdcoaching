<%-- 
    Document   : VoirProgramme
    Created on : 4 avr. 2018, 17:24:38
    Author     : evaba
--%>
...
<html>
    <head>
        ...
        <title>Programme des clients</title>
            ...
            <div class="container">
                <div class="row mar-bot40">
                    ...
                    <%  String mail = request.getParameter("email");
                        bd unebd = new bd();
                        String infoprog = unebd.recupererUtiPG(mail);
                        if (infoprog != null) {
                            out.println(infoprog);
                        } else {
                            session.setAttribute("emailCli", mail);
                            out.println("<script LANGUAGE='JavaScript'>");
                            out.println("alert('Ce client n\\'a pas encore de programme à faire, please l\\'affectez!!!');window.location='affecterCliPG.jsp'");
                            out.println("</script>");
                        }
                    ...
                    %>
                        ...
                        <a href="ListClient.jsp"> Retour a la liste des clients </a>
                </div>
            </div>
        </section>
