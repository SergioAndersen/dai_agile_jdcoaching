<%-- 
    Document   : ajoutProf
    Created on : 3 avr. 2018, 15:03:15
    Author     : evaba
--%>
                ...
                <div class="row mar-bot40">
                    <div class="col-md-offset-3 col-md-6">
                        ...
                        <div class="container">
                            ...
                            <div class="col-md-5">
                                ...
                                <%
                                    ...
                                    for (Profil p : lstPro) {
                                        out.println("<ul><li>" + p.getDescriptionPro() + "</li></ul>");
                        ...
                        <div class="cform" id="contact-form">
                            <form action="ajouterPro" method="get" name="ajouterPro">
                                <div class="section-header">
                                    <h2 class="section-heading animated" data-animation="bounceInUp">Ajouter un profil</h2>
                                </div>
                                <div class="col-md-7">
                                    <input type="text" name="txtprof" value=""/>
                                </div>
                                <div class="col-md-5">
