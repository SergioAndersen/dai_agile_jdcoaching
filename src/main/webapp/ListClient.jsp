<%-- 
    Document   : ListClient
    Created on : 4 avr. 2018, 16:21:41
    Author     : evaba
--%>
        ...
        <section id="section-services" class="section pad-bot30 bg-white">
            <div class="container">
                <div class="row mar-bot40">
                    ...
                    <div class="col-lg-11">
                        <h3 class="text-bold">La liste des clients abonnés :</h3>

                        <div class="cform" id="contact-form">
                            <form method = 'get' action = 'VoirProgramme.jsp'>
                                <div id='clientValider'></div>
                                <input type="submit" name="submit" value="Voir programme" class="btn btn-theme "/>
                            </form>
                        </div>
                    </div>
                </div>
